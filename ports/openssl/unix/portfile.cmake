...
elseif(VCPKG_TARGET_IS_IOS)
    if(VCPKG_TARGET_ARCHITECTURE MATCHES "arm64")
        ...
        set(OPENSSL_IOSSIMULATOR_ARCH iossimulator-arm64-xcrun)
    elseif(VCPKG_TARGET_ARCHITECTURE MATCHES "arm")
        set(OPENSSL_ARCH ios-xcrun)
        set(OPENSSL_IOSSIMULATOR_ARCH iossimulator-xcrun)
    elseif(VCPKG_TARGET_ARCHITECTURE MATCHES "x86")
        set(OPENSSL_ARCH iossimulator-i386-xcrun)
    elseif (VCPKG_TARGET_ARCHITECTURE MATCHES "x64")
        set(OPENSSL_ARCH iossimulator-x86_64-xcrun)
    else()
        message(FATAL_ERROR "Unknown iOS target architecture: ${VCPKG_TARGET_ARCHITECTURE}")
    endif()
    if(DEFINED OPENSSL_IOSSIMULATOR_ARCH AND VCPKG_OSX_SYSROOT MATCHES ".*iPhoneSimulator.*")
        set(OPENSSL_ARCH ${OPENSSL_IOSSIMULATOR_ARCH})
    endif()
